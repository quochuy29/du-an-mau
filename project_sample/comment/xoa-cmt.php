...
$commentten_loai = isset($_GET['tenloai']) ? $_GET['tenloai'] : 1;
...
header("location: http://localhost/php1/project_sample/chi-tiet.php?ma_hh=$commentId_hh&tenloai=$commentten_loai");
?>