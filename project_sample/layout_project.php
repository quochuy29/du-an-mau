...
$getProductsQuery = "select * from products order by luot_xem desc LIMIT 3,3";
    ...
    <div class="full-body">
        ...
        <div class="product">
            ...
            <div class="list-product">
                ...
                <div class="row">
                    <?php foreach ($products1 as $keys => $cursors): ?>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="margin-bottom:20px">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="border:1px solid #cdcdcd">
                            <a href="chi-tiet.php?ma_hh=<?= $cursors['ma_hh'] ?>&tenloai=<?= $cursors['tenloai'] ?>"><img
                                    style="margin-left:30px;" width=219 height=178
                ...
                <div class="products">
                    ...
                    <a class="view-all" href="like.php">Xem tất cả &gt;</a>
                </div>
                <div class="row">
                    <?php
			            foreach ($products5 as $keys => $cursors): ?>
